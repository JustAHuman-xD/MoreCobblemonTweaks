...
public class Textures {
    ...
    public static final Identifier TEXT_FIELD_TEXTURE = new Identifier("dystoriantweaks", "textures/gui/pc/text_field.png");
    public static final Identifier CANCEL_BUTTON_TEXTURE = new Identifier("dystoriantweaks", "textures/gui/pc/cancel_button.png");
    public static final Identifier CONFIRM_BUTTON_TEXTURE = new Identifier("dystoriantweaks", "textures/gui/pc/confirm_button.png");
