...
public class Textures {
    public static final Map<String, ResourceLocation> POSSIBLE_WALLPAPER_TEXTURES = new HashMap<>();
    public static final ResourceLocation IV_WIDGET_TEXTURE = MoreCobblemonTweaks.id("textures/gui/pc/iv_display.png");
    public static final ResourceLocation RENAME_BUTTON_TEXTURE = MoreCobblemonTweaks.id("textures/gui/pc/rename_button.png");
    public static final ResourceLocation WALLPAPER_BUTTON_TEXTURE = MoreCobblemonTweaks.id("textures/gui/pc/wallpaper_button.png");
    public static final ResourceLocation SEARCH_BUTTON_TEXTURE = MoreCobblemonTweaks.id("textures/gui/pc/search_button.png");
